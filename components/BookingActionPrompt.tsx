...
export default function BookingActionPrompt({
	...
	const submitClass =
		variant === 'cancel'
			? 'group relative inline-flex w-full items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-aurora-magenta via-aurora-magenta to-rose-600 px-4 py-3.5 text-sm font-semibold tracking-wide text-white shadow-[0_4px_24px_-6px_rgba(236,72,153,0.6)] transition-[background-color,border-color,color,box-shadow] duration-300 hover:shadow-[0_6px_32px_-6px_rgba(236,72,153,0.8)] focus:outline-none focus-visible:ring-2 focus-visible:ring-aurora-magenta focus-visible:ring-offset-2 focus-visible:ring-offset-nearBlack'
			: 'group relative inline-flex w-full items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-gold-glow via-gold-soft to-gold-soft px-4 py-3.5 text-sm font-semibold tracking-wide text-nearBlack shadow-[0_4px_24px_-6px_rgba(232,184,0,0.6)] transition-[background-color,border-color,color,box-shadow] duration-300 hover:shadow-[0_6px_32px_-6px_rgba(232,184,0,0.8)] focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-glow focus-visible:ring-offset-2 focus-visible:ring-offset-nearBlack'
